...
class mymath:
    ...
    def sixstokes2mueller(self,S,sizex,sizey,polarized_light_type,name):
        ...
        fig.savefig('result/v9/figure_ori'+str(name)+'.png')
        np.save('result/v9/ori_'+str(name), M)
        ...
        #         # norm=np.amax(MM[:,:,row,colum,idW])
                ...
                colorbar = plt.colorbar()
                plt.clim(-1,1)
        fig.savefig('result/v9/figure_nor1'+str(name)+'.png')
        np.save('result/v9/nor1_'+str(name), M1)
        ...
        fig.savefig('result/v9/figure_nor2'+str(name)+'.png')
        np.save('result/v9/nor2_'+str(name), M2)
