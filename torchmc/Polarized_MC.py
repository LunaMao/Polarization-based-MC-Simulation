...
def main():
    ...
    # for idW,Lambda in  enumerate(spectrum):
        ...
        colorbar = plt.colorbar()
        fig.savefig('result/v8/DP_'+str(Lambda)+'_'+str(N_photons)+'_'+str(pattern)+'_'+str(beam_radius)+'_'+str(r)+'_'+str(vf)+'_'+str(x_max)+'.png')
        np.save('result/v8/DP_'+str(N_photons)+'_'+str(Lambda)+'_'+str(pattern)+'_'+str(beam_radius)+'_'+str(vf)+'_'+str(Npar)+'_'+str(event)+'_'+str(x_max)+'_'+str(D[idW,1]), MM[:,:,:,:,idW])
